...
`,v=[];return a.overrides&&(v=a.overrides.map(d=>{let b=pe(d.tokens),g=Fr(b).map(f=>`${f.name}: ${f.value};`).join(`
...
`),y(m({},d),{tokens:b})})),{tokens:t,breakpoints:s,name:l,cssText:u,overrides:v}}o();o();function ys(r){return typeof r=="object"?r.hasOwnProperty("value"):!1}var As=zr({name:"default-theme"},Z);export{C as AuthChallengeNames,xt as DefaultTexts,qr as FederatedIdentityProviders,q as LoginMechanismArray,M as authInputAttributes,za as censorAllButFirstAndLast,Ba as censorPhoneNumber,qa as countryDialCodes,Sn as createAuthenticatorMachine,zr as createTheme,As as defaultTheme,jr as getActorContext,Q as getActorState,_a as getAliasInfoFromContext,Ua as getConfiguredAliases,$r as getSendEventAliases,Kr as getServiceContextFacade,Na as getServiceFacade,wt as hasTranslation,ys as isDesignToken,Oa as listenToAuthHub,ga as signUpFieldsWithDefault,fa as signUpFieldsWithoutDefault,kt as translate,Tt as translations};
